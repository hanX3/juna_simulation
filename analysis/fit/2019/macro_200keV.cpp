{
  ...
  gROOT->ProcessLine("getrootfile(200, 198.2)");
  gROOT->ProcessLine("getrootfile(200, 198.3)");
  gROOT->ProcessLine("getrootfile(200, 198.4)");
  gROOT->ProcessLine("getrootfile(200, 198.5)");
  gROOT->ProcessLine("getrootfile(200, 198.6)");
  gROOT->ProcessLine("getrootfile(200, 198.7)");
  gROOT->ProcessLine("getrootfile(200, 198.8)");
  gROOT->ProcessLine("getrootfile(200, 198.9)");
