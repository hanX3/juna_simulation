...
//rise part
double risepartstart = 2230.;
double risepartstop = 2260.;
...
//fall part
double fallpartstart = 2265.5;
double fallpartstop = 2269.5;
...
void analysis(double proton_energy)
{
  ...
  std::ofstream ofs;
  ofs.open ("../../../../../../result/2019/350keV/chi2_fall_part.dat", std::ofstream::out | std::ofstream::app);

  //data path
  char filename[1024];
  char savepdf[1024];
  sprintf(filename, "../../../../../../rootfile/2019/proton_%0.1fkeV.root", proton_energy);
  sprintf(savepdf, "../../../../../../result/2019/350keV/fall_part_%0.1f.pdf", proton_energy);
  ...
  grexp->GetXaxis()->SetRangeUser(2180., 2280.);
  grexp->GetYaxis()->SetRangeUser(0., 1400.);
  ...
  gtemp->GetXaxis()->SetRangeUser(2260., 2270.);
  gtemp->GetYaxis()->SetRangeUser(0., 1400.);
  gtemp->Draw("AP");
  grsimulationscale->Draw("P same");
  tffallp->Draw("same");
  tfbg->Draw("same");
